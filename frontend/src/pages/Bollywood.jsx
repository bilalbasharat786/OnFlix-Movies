...
const Bollywood = () => {
  ...
  // === SMART FILTER: Bollywood + Search ===
  const filteredMovies = movies.filter((movie) => {
    // Sirf Hindi language wali movies Bollywood page par aayengi
    const isBollywood = movie.language === 'Hindi';
    const matchesSearch = movie.title.toLowerCase().includes(searchQuery.toLowerCase());
    return isBollywood && matchesSearch;
  });
